...
class MSResNet(nn.Module):
    def __init__(self, input_channel, layers=[1, 1, 1, 1], num_classes=2):
        ...
        self.maxpool3 = nn.AvgPool1d(kernel_size=250, stride=1, padding=0)
        ...
        self.maxpool5 = nn.AvgPool1d(kernel_size=245, stride=1, padding=0)
        ...
        self.maxpool7 = nn.AvgPool1d(kernel_size=240, stride=1, padding=0)
